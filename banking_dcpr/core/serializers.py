    ...
    def validate(self, data):
        ...
        if resulting_balance < 0:
            raise serializers.ValidationError(
                "Insufficient funds: this transaction would make the bank balance negative."
            )
        ...
        if date:
            ...
            if ending < 0:
                raise serializers.ValidationError(
                    "This transaction would make the daily ending balance negative for the selected date."
                )
